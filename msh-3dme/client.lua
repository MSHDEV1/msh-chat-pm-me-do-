...
RegisterCommand('me', function(source, args, raw)
    ...
    QBCore.Functions.TriggerCallback('3dme:sex', function(firstname, lastname)
        ...
        local name = firstname ..' '..  lastname..':'
          ...
          TriggerServerEvent('msh-3dme:shareDisplay', text, name)
    end)
end)
...
RegisterNetEvent('msh-3dme:shareDisplay')
AddEventHandler('msh-3dme:shareDisplay', function(text, serverId, name)
